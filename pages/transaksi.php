...
// lalu $_GET["id"] disimpan ke dalam variable $id
    ...
    <body> 
            ...
            <form action="" method="POST"> 
                <div class="row"> 
                    <div class="col-md-6 col-sm-12"> 
                        ...
                        <div class="mb-2"> 
                            <label for="merek" class="form-label">Pilih Rumah</label> 
                            <input type="text" id="produk" class="form-control" value="<?= $rumah[$id][0] ?>" readonly> 
                        </div> 
        ...
        <script> 
            ...
            function hitungTotal() { 
                ...
                //jika harga sama dengan id='#harga'
